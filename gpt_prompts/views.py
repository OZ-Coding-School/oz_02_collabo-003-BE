...
class GptZodiac(APIView):
    ...
    def post(self, request):
        ...
        if zodiac_prompt:
            ...
            suffix_prompt2 = '12간지 중에서 작성해야하는 띠와 태어난 년도야. [말]1966년생, 1978년생, 1990년생, 2002년생 (총 4개), [양]1967년생, 1979년생, 1991년생, 2003년생 (총 4개), [원숭이]1956년생, 1968년생, 1980년생, 1992년생 (총 4개), [닭]1957년생 ,1969년생, 1981년생, 1993년생 (총 4개), [개]1958년생, 1970년생, 1982년생, 1994년생 (총 4개), [돼지]1959년생, 1971년생, 1983년생, 1995년생 (총 4개) 작성해줘'
